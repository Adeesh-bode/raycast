...
const Switch: React.FC<SwitchProps> = ({ selectWindow }) => { // or can have assign inline type 
    ...
    return (
        <div className="w-full h-20 md:h-24 md:mb-8 flex-center">
            <div className="w-fit h-16 md:h-20 flex-center gap-2 md:gap-2 py-1 md:py-3 px-2 md:px-3 rounded-xl md:rounded-3xl bg-neutral-900/70 border border-neutral-600 overflow-y-visible">
