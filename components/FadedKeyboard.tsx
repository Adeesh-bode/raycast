  ...
  return (
    <div className='flex flex-col justify-start items-center w-full h-full gap-2'>
        ...
        <div className=' flex justify-between items-center gap-2'>
            <div className='flex justify-start items-end p-2 border-2  border-neutral-600 bg-neutral-950  rounded-md w-36 h-16 '>
                esc
            </div>
            <div className='flex justify-start items-end p-2 border-2 border-neutral-600 bg-neutral-950 rounded-md w-16 h-16'>
                F1
            </div>
            <div className='flex justify-start items-end p-2 border-2 border-neutral-600 bg-neutral-950 rounded-md w-16 h-16'>
                F2
        ...
        <div className=' flex justify-between items-center gap-2 text-xl'>
            <div className='flex flex-col justify-center items-center border-2 border-neutral-600 bg-neutral-950 rounded-md w-20 h-[90px]'>
